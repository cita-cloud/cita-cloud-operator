...
func (in *ChainConfigStatus) DeepCopyInto(out *ChainConfigStatus) {
	*out = *in
	if in.AdminAccount != nil {
		in, out := &in.AdminAccount, &out.AdminAccount
		*out = new(AdminAccountInfo)
		**out = **in
	}
	if in.ValidatorAccountList != nil {
		in, out := &in.ValidatorAccountList, &out.ValidatorAccountList
		*out = make([]ValidatorAccountInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ValidatorAccountInfo) DeepCopy() *ValidatorAccountInfo {
	if in == nil {
		return nil
	}
	out := new(ValidatorAccountInfo)
	in.DeepCopyInto(out)
	return out
}
